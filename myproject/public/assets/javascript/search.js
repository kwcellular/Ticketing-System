...
// --------------------- EVENT LISTENERS - START ---------------------
	...
	// print
	$('#chej').on('click', prepareModalPrint); 
	...
	// label
	$('#prtlabel').on('click', prepareModalPrintLabel); 
	$('#print-label-button').on('click', function(){
        printJS('print-view-label', 'html');
...
//----------------- </REPORTS>
    ...
    function addNewNoteInTicket() {
        ...
        inputAreaDate.val(moment().format("YYYY-MM-DD"));
        inputAreaDate.prop('disabled', true);
        controlDate.append(inputAreaDate);
    ...
    function paymentDone() {
        if (hidePaymentSection) {
            ...
            paymentCompletedDateSelector.val(moment().format("YYYY-MM-DD"));
    ...
    function deliverDone() {
        if (hideDeliverSection) {
            ...
            deliverCompletedDateSelector.val(moment().format("YYYY-MM-DD"));
	...
	function prepareModalPrint() {
		...
		phNum = cellNumSelector.val().trim();
		...
		$('#print-view-ticket-ph').text(phNum);
	...
	// label print function
		function prepareModalPrintLabel() {
        ...
        // Activate and pass the values to the modal
        $('#modal-label').addClass('is-active');
		$('#modal-label').show();

        //addTicketButton.hide();
        
        $('#print-view-label-num').text(fullTicketNum);
        $('#print-view-label-date').text(date);
        $('#print-view-label-cust').text(custName  + ' ' + custLastName);
		$('#print-view-label-ph').text(phNum);
        $('#print-view-label-brandmodel').text(eqBrand + eqModel);
        $('#print-view-label-serial').text(eqSerialNum);
        $('#print-view-label-characteristics').text(characteristics);
        $('#print-view-label-accesories').text(accesories);
        $('#print-view-label-reason').text(reasonToVisit);
    }
